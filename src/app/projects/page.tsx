...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: "Página de destino para produto SaaS focado em produtividade e colaboração entre times.",
  ...
  },
  {
    ...
    description: "Conjunto de componentes reutilizáveis com design system consistente e documentação.",
  ...
  },
  {
    ...
    description: "Ferramenta de linha de comando para automação de fluxos de trabalho de desenvolvimento.",
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Meus <span className="text-gradient">Projetos</span></h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">Explore meu portfólio de trabalhos e projetos pessoais, destacando minhas habilidades e experiências com diversas tecnologias.</p>
          </div>
